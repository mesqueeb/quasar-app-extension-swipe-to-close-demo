  ...
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-list>
        ...
        <q-item clickable tag="a" target="_blank" href="https://github.com/mesqueeb/quasar-app-extension-swipe-to-close">
          <q-item-section avatar>
            <q-icon name="ion-code" />
          </q-item-section>
          <q-item-section>
            <q-item-label>Github: Extension</q-item-label>
            <q-item-label caption>mesqueeb/quasar-app-extension-swipe-to-close</q-item-label>
          </q-item-section>
        </q-item>
